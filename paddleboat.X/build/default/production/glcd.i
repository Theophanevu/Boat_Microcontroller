...
const unsigned char Boat_matrix[40] = {
    0x00, 0x0E, 0x1E, 0x3C, 0x3C, 0x78, 0x70, 0x00,
 0x08, 0x0C, 0x1C, 0x1C, 0x38, 0x38, 0x30, 0x10,
    0x18, 0x18, 0x3C, 0x3C, 0x3C, 0x3C, 0x18, 0x18,
 0x10, 0x30, 0x38, 0x38, 0x1C, 0x1C, 0x0C, 0x08,
    0x00, 0x70, 0x78, 0x3C, 0x3C, 0x1E, 0x0E, 0x00
};
...
void glcd_WriteBoat(signed char angle, unsigned char posY)
{
 ...
 unsigned int chr;
    ...
    for(i = 0; i < 8; i++)
    {
        glcd_WriteByte(side, Boat_matrix[chr+i]<<carry);
        xpos++;
 }
    ...
    if(carry > 0 && ypos<8){
        ...
        for(i = 0; i < 8; i++)
        {
            glcd_WriteByte(side, Boat_matrix[chr+i]>>(8-carry));
            xpos++;
        }
    }
